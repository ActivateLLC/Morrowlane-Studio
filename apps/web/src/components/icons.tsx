...
const PATHS: Record<string, string> = {
  ...
  rocket: 'M12 4c3 1 5 4 5 8l-2.5 2.5h-5L7 12c0-4 2-7 5-8Zm0 6.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM9.5 16.5 8 20m6.5-3.5L16 20M9.5 14.5 7.5 16m7 -1.5L16.5 16',
};
