                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="mt-1.5 flex flex-wrap items-center gap-3">
                          ...
                          <Link
                            ...
                            className="min-h-11 inline-flex items-center text-[12px] font-medium text-accent-strong hover:underline"
                          >
                            Edit
                          </Link>
                        </div>
            ...
            <Button
              ...
              onClick={() =>
                run(async () => {
                  ...
                  setSelected(new Set());
                  setMessage(
                    `Approved ${result.approved}${result.blocked > 0 ? ` · ${result.blocked} held by a brand rule` : ''}.`,
                  );
                })
              }
            >
