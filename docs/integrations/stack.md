...
| Hugging Face | open-model text + image inference | gateway provider via the OpenAI-compatible router (`HF_TOKEN`; GLM-5.3-Flash / DeepSeek-V4-Flash defaults) and the FLUX image renderer in `packages/creative-engine` |
